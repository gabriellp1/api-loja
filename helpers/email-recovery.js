...
const message = `
    ...
    <br /><br /><hr />
    <p>
        Obs:Se voce não solicitou a redefinição, apenas ignore esse email.
    </p>
    <br />
    <p>Atenciosamente, JJ refrigeração</p>
`;

const opcoesEmail = {
    from: "naoresponder@jjrefrigeracao.com",
    to: usuario.email,
    subject: "Redefinição de senha - JJ Refrigeração",
    html: message
};
